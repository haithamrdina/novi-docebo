                    ...
                    <div class="col d-flex flex-column">
                        <form action="{{ route('settings.novi.update') }}" method="post">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row g-3">
                                    <div class="col-md">
                                        <input type="text" name="novi-endpoint" class="form-control" value="{{ config('novi.endpoint') }}">
                                    </div>
                                </div>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md">
                                            <div class="input-group input-group-flat">
                                                <input type="password" id="novi-password" name="novi-password" class="form-control" placeholder="Your password" value="{{ config('novi.apikey') }}">
                                                <span class="input-group-text">
                                                    <a href="#" class="link-secondary"
                                                        onclick="toggleNoviPasswordVisibility()">
                                                        <span id="novi-showPasswordIcon">
...
<script>
    ...
    function toggleNoviPasswordVisibility() {
        var passwordInput = document.querySelector('#novi-password');
        var icon = document.querySelector('#novi-showPasswordIcon');
